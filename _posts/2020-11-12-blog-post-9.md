...
```
![简单的分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot40.jpeg)
...
plot(wrld_simpl, add = TRUE)}
```
![简单的分布2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot41.jpeg)
接下来我们可以检查是否有重复的点：
```r
...
points(oaks_nodups$Longitude, oaks_nodups$Latitude, pch = 16, col = "black")}
```
![多边形边界](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot42.jpeg)
```r
#只对一个种绘制简单边界
...
#注意，上面是套娃式的一整句语句
```
![多边形边界2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot43.jpeg)
...
```
![动态阿尔法边界](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot44.jpeg)
好像还是很扯淡。
### 多样性的梯度（点数据的范围（不简单）
...
```
![多样性的分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot45.jpeg)
```r
#换颜色
...
plot(wrld_simpl, add = T)}
```
![多样性的分布2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot46.jpeg)
...
plot(wrld_simpl, add = T)}
```
![MRD](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot47.jpeg)
```r
#把两张图合并
{par(mfrow = c(1, 2))
plot(f_sr_raster, col = rev(colfuncYellows(100)), axes = FALSE, box = FALSE, 
...
plot(f_MRD_raster, col = rev(colfuncYellows(100)), axes = FALSE, box = FALSE, 
     ...
     xlab = "Furnariides mean root distance", legend.width = 2)}
```
![MRD与生物多样性](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot48.jpeg)
#### 尺度依赖问题
...
```
看看有什么区别呢？
![不同格网](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot49.jpeg)
### 物种分布模型？
...
```
![分布地气候](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot50.jpeg)
...
```
![分别相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot51.jpeg)
#### 空间自相关
...
```
![残差自相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot52.jpeg)
...
title(main = "OLS residuals", cex = 1.5)}
```
![残差和多样性自相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot53.jpeg)
...
title(main = "Correlogram SARerr", cex = 1.5)}
```
![空间自相关的比较](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot54.jpeg)
那是真的没有相关。
...
map(add = T)
```
![clim1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot58.jpeg)
...
ncell(clima0k.SA)
```
![clim1-1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot59.jpeg)
```r
...
```
![因子分析](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot60.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot61.jpeg)
### 生态位模型的拟合与预测
有了这些数据我们就可以开始演算了。
...
plot(Bioclim.model)
```
![bioclim1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot62.jpeg)
让我们绘制模型的响应变量或单个变量响应曲线。
```r
response(Bioclim.model)
```
![bioclim2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot63.jpeg)
进行分布区预测
```r
...
```
![bioclim3](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot65.jpeg)
测试数据
```r
...
```
![Gower1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot64.jpeg)
#### 支持向量机SVM
...
plot(GLM0k, main = "glm")
```
![4图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot66.jpeg)
比较四个模型的ROC值
```r
par(mfrow = c(2, 2))
...
plot(glm.eval, "ROC")
```
![AUC](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot67.jpeg)
添加了阈值限制后的物种适宜分布区
```r
par(mfrow = c(2, 2))
...
```
![阈值](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot68.jpeg)
...
plot(map.sum > 3)
```
![和](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot69.jpeg)
也可以查看他们的平均结果
```r
map.mean <- mean(tmp)
map.sd <- calc(tmp, sd)
...
plot(map.mean > 0.3)
```
![平均](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot70.jpeg)
...
```
![加权](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot71.jpeg)
## 运用光谱数据调查生物多样性
...
```
![光谱1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot72.jpeg)
...
```
![光谱分位数](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot73.jpeg)
...
```
![光谱全图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot74.jpeg)
### 基于遥感的生态指标
...
plot(ProLau_data)
```
![数据分布图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot87.jpeg)
```r
#定义单个模型的选项
ProLau_opt <- 
...
```
如随机森林的变量响应模型：
![rf_eval_strip](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot88.jpeg)
```r
#运行集成模型
...
```
![cSRC](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot90.jpeg)
```r
#计算SRC分布概率的分层密度
#参考项目
...
```
![dis](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot91.png)
![modelcom](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot92.png)
### 多变量模型拟合与预测
```r
## setup environment ----
setwd('workdir')
...
```
![kissmig1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot93.jpeg)
```r
# 运行kissmig并输出各种东西
...
```
![kissmig2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot94.jpeg)
```r
# 探索地理空间

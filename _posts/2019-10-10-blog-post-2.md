...
```
![anova图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot.jpeg)
接下来可以根据p值绘制带有标注的anova图：
```r
p + stat_compare_means(method = "anova",label.y = 1) +
  stat_compare_means(label = "p.signif", method = "t.test", ref.group = ".all.")
```
![anova图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot15.jpeg)
## 相关分析
### cor函数
...
```
![基础cor图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot83.jpeg)
控制单元格形状和内容：
```r
...
```
![进阶cor图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot84.jpeg)
设置可以混合显示：
```r
...
```
![进阶cor图2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot85.jpeg)
对变量进行聚类等：
```r
corrplot(corr=matrix,method = "color",order = "hclust",tl.col="black",addrect=4,addCoef.col = "grey")
```
![进阶cor图3](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot86.jpeg)
## 聚类分析
### 系统聚类
...
```
结果如下：
![聚类分析1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot20.jpeg)
加下来分别使用其他方法再试试：
```r
#最长距离法
...
```
这图炸了啊
![聚类分析2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot21.jpeg)
```r
#再用kmeans看看，分为两类进行聚类
cl = kmeans(x,2)
...
![kmeans聚类](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot22.jpeg)
## 主成分分析
...
```
流石图：
![主成分分析1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot23.jpeg)
最后结果：
![主成分分析2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot24.jpeg)
...
```
就很nb。
![主成分分析3](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot25.jpeg)
## 统计检验

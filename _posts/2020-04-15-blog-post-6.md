...
![plot1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot1.jpeg)
```r
#autoplot可以自动生成合适的图表
...
autoplot(a10) +
  ...
  xlab("Year")
```
![plot2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot2.jpeg)
...
```
![plot3](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot3.jpeg)
...
```
![plot4](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot4.jpeg)
也可以把每个季节的数据搜集在一起来显示：
```r
ggsubseriesplot(a10) +
  ylab("$ million") +
...
```
![plot5](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot5.jpeg)
### 散点图
...
```
![plot6](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot6.jpeg)
我们可以通过绘制一个序列与另一个序列的散点图来研究用电需求与温度之间的关系。
```r
qplot(Temperature, Demand, data=as.data.frame(elecdemand)) +
  ylab("Demand (GW)") + xlab("Temperature (Celsius)")
```
![plot7](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot7.jpeg)
...
```
![plot8](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot8.jpeg)
显示它们的散点图矩阵（需要GGally包）
```r
GGally::ggpairs(as.data.frame(visnights[,1:5]))
```
![plot9](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot9.jpeg)
...
gglagplot(beer2)
```
![plot10](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot10.jpeg)
...
ggAcf(beer2)
```
![plot11](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot11.jpeg)
蓝色虚线外表示相关性是否显着不为零。
...
```
![plot12](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot12.jpeg)
```r
ggAcf(aelec, lag=48)
```
![plot13](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot13.jpeg)
### 白噪声
...
```
![plot14](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot14.jpeg)
```r
ggAcf(y)
```
![plot15](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot15.jpeg)
...
```
![plot16](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot16.jpeg)
当然，这些方法都不是很靠谱。
### 数据预处理
...
```
![plot17](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot17.jpeg)
...
autoplot(eggs) +
  ...
  guides(colour=guide_legend(title="Forecast"))
```
![plot18](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot18.jpeg)
### 残差诊断
...
```
![plot19](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot19.jpeg)
进行朴素预测：
```r
...
```
![plot20](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot20.jpeg)
绘制残差直方图，右尾确实有点长：
```r
gghistogram(res) + ggtitle("Histogram of residuals")
```
![plot21](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot21.jpeg)
绘制ACF，可以认为缺乏相关性，因此预测结果不错
```r
ggAcf(res) + ggtitle("ACF of residuals")
```
![plot22](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot22.jpeg)
...
autoplot(window(ausbeer, start=1992)) +
  ...
  guides(colour=guide_legend(title="Forecast"))
```
![plot23](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot23.jpeg)
...
```
![plot24](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot24.jpeg)
...
```
![plot25](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot25.jpeg)
显然消费和支出有线性关系：
绘图：
```r
uschange %>%
...
```
![plot26](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot26.jpeg)
计算回归系数：
```r
...
uschange %>%
  ...
  GGally::ggpairs()
```
![plot27](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot27.jpeg)
### 最小二乘估计
...
```
![plot28](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot28.jpeg)
```r
...
```
![plot29](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot29.jpeg)
接下来我们可以评估该结果：
```r
...
```
![plot30](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot30.jpeg)
...
```
![plot31](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot31.jpeg)
...
autoplot(marathon) +
  ...
  guides(colour = guide_legend(title = " "))
```
![plot32](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot32.jpeg)
...
marathon %>%
  ...
  autoplot()
```
![plot33](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot33.jpeg)
## 时间序列的分解
...
```
![plot34](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot34.jpeg)
进行5阶平均：
```r
ma(elecsales, 5)
```
...
autoplot(elecsales, series="Data") +
  ...
  scale_colour_manual(values=c("Data"="grey50","5-MA"="red"),
                      breaks=c("Data","5-MA"))
```
![plot35](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot35.jpeg)
...
```
![plot36](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot36.jpeg)
...
```
![plot37](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot37.jpeg)
使用季节性部分的季节性图和季节性子系列图可能很有用。这些有助于我们直观地看到季节性成分随时间的变化。下图显示了上图中季节部分的季节子序列图。在这种情况下，随着时间的推移只有很小的变化。
```r
fit %>% seasonal() %>% ggsubseriesplot() + ylab("Seasonal")
```
![plot38](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot38.jpeg)
### SEATS分解
...
```
![plot39](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot39.jpeg)
...
elecequip %>%
  ...
  autoplot()
```
![plot40](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot40.jpeg)
...
```
![plot41](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot41.jpeg)
进行简单指数平滑：
```r
oildata <- window(oil, start=1996)
# Estimate parameters
...
autoplot(fc) +
  ...
  ylab("Oil (millions of tonnes)") + xlab("Year")
```
![plot42](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot42.jpeg)
### 趋势法
...
autoplot(air) +
  ...
  guides(colour=guide_legend(title="Forecast"))
```
![plot43](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot43.jpeg)
### Holt-Winters的季节性方法
...
autoplot(aust) +
  ...
  guides(colour=guide_legend(title="Forecast"))
```
![plot44](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot44.jpeg)
这也有一种阻尼法，可以具有衰减的趋势：
```r
...
```
![plot45](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot45.jpeg)
### 模型选择与估计
`est`函数可以进行模型的估计与选择：
```r
...
autoplot(fit)
```
![plot46](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot46.jpeg)
获得残差：
```r
...
```
![plot47](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot47.jpeg)
...
```
![plot48](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot48.jpeg)
...
```
![plot49](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot49.jpeg)
以下R代码用于自动选择模型:
```r
...
```
![plot50](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot50.jpeg)
...
```
![plot51](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot51.jpeg)
```r
ggPacf(uschange[,"Consumption"])
```
![plot52](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot52.jpeg)
...
```
![plot53](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot53.jpeg)
数据显然是不稳定的，具有一定的季节性，因此我们先考察季节性差异：
```r
euretail %>% diff(lag=4) %>% ggtsdisplay()
```
![plot54](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot54.jpeg)
```r
euretail %>% diff(lag=4) %>% diff() %>% ggtsdisplay()
```
![plot55](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot55.jpeg)
...
```
![plot56](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot56.jpeg)
...
```
![plot57](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot57.jpeg)
因此，我们现在有了一个季节性的ARIMA模型，该模型可以通过所需的检查并可以进行预测:
```r
fit3 %>% forecast(h=12) %>% autoplot()
```
![plot58](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot58.jpeg)
...
autoplot(uschange[,1:2], facets=TRUE) +
  ...
  ggtitle("Quarterly changes in US consumption
    and personal income")
```
![plot59](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot59.jpeg)
把收入作为一个预测变量加入模型：
```r
...
```
![plot60](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot60.jpeg)
也可以查看整个ARIMA模型和白噪声：
```r
checkresiduals(fit)
```
![plot61](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot61.jpeg)
进行预测：
```r
...
```
![plot62](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot62.jpeg)
### 随机与确定趋势（斜率？
...
```
![plot63](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot63.jpeg)
我们使用确定趋势的模型：
```r
...
autoplot(austa) +
  ...
  guides(colour=guide_legend(title="Forecast"))
```
![plot64](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot64.jpeg)
### 动态谐波回归
...
```
![plot65](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot65.jpeg)
### 滞后预测变量
...
```
![plot66](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot66.jpeg)
...
```
![plot67](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot67.jpeg)
## 分层/组时间序列的预测
...
```
![plot68](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot68.jpeg)
探索趋势：
```r
calls %>% mstl() %>%
  autoplot() + xlab("Week")
```
![plot69](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot69.jpeg)
进行预测：
```r
calls %>% stlf() %>%
  autoplot() + xlab("Week")
```
![plot70](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot70.jpeg)
...
fit %>%
  ...
  autoplot(include=5*169) +
     ylab("Call volume") + xlab("Weeks")
```
![plot71](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot71.jpeg)
### 向量自回归
...
forecast(var3) %>%
  autoplot() + xlab("Year")
```
![plot72](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot72.jpeg)
### 神经网络模型
...
```
![plot73](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot73.jpeg)
...
```
![plot74](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot74.jpeg)
不断重复就能画出预测区间了，PI就是预测次数，默认是FALSE，因为很占用计算资源。
```r
fcast <- forecast(fit, PI=TRUE, h=30)
autoplot(fcast)
```
![plot75](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot75.jpeg)
### 重复抽样与套袋
...
```
![plot76](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot76.jpeg)
...
```
![plot77](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot77.jpeg)
...
autoplot(debitcards) +
  ...
  guides(colour="none")
```
![plot78](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot78.jpeg)
...
```
![plot79](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Forecast/Rplot79.jpeg)

...
###
```
![plot7](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot07.jpeg)
![plot8](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot08.jpeg)
### 预训练网络与微调
...
plot(history)
```
![plot9](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot09.jpeg)
![plot10](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot10.jpeg)
训练完整模型：
```r
...
history = model %>%
  fit_generator(train_gen,
                ...
                validation_steps = as.integer(num_validation_samples / batch_size))
```
![plot11](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot11.jpeg)
...
```
![plot12](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot12.jpeg)
```r
qplot(log(data$favorite_count + 1))
```
![plot13](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot13.jpeg)
```r
qplot(data$retweet_count)
summary(data)
table(data$source, useNA = "ifany")
```
![plot14](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot14.jpeg)
...
plot(history)
```
![plot15](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot15.jpeg)
评估模型：
```r
...
qplot(preds)
```
![plot16](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot16.jpeg)
```r
...
```
![plot17](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot17.jpeg)
### 尝试其他模型结构
```r
(vocab_size = tokenizer$num_words)
...
plot(history)
```
![plot18](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot18.jpeg)
### 模型2
评估模型2：
```r
(eval_loss = model %>% evaluate(test_data, y_test, verbose = 0))
...
qplot(preds)
```
![plot19](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot19.jpeg)
```r
qplot(preds, y_test) + geom_smooth() + theme_minimal()
...
```
![plot20](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/deeplearning/Rplot20.jpeg)
...
- [Biodiversity](#biodiversity)
  ...
  - [Using Spectral Data to Investigate Biodiversity](#using-spectral-data-to-investigate-biodiversity)
    - [Get band spectrum](#get-band-spectrum)
    - [Ecological indicators based on remote sensing](#ecological-indicators-based-on-remote-sensing)
- [Connect plot, traits and environment](#connect-plot-traits-and-environment)
  - [RQL analysis](#rql-analysis)
    - [Data exploring](#data-exploring)
    - [Multiple Generalized Linear Regression (mGLM)](#multiple-generalized-linear-regression-mglm)
    - [multipleSDM](#multiplesdm)
    - [Forth corner analysis](#forth-corner-analysis)
    - [Variable selection (based on LASSO)](#variable-selection-based-on-lasso)
- [Biogeography](#biogeography)
  - [Diversity and distributions](#diversity-and-distributions)
    - [Data preparation and geographic visualization](#data-preparation-and-geographic-visualization)
    - [Range of occurance](#range-of-occurance)
      - [Based on the minimum convex polygon (Convex hull)](#based-on-the-minimum-convex-polygon-convex-hull)
      - [Boundary based on dynamic Alpha](#boundary-based-on-dynamic-alpha)
    - [Biodiversity gradients (based on boundary)](#biodiversity-gradients-based-on-boundary)
      - [Scale dependence problem](#scale-dependence-problem)
    - [Specie distribution model](#specie-distribution-model)
      - [Spatial autocorrelation](#spatial-autocorrelation)
  - [Species distribution and niche theory](#species-distribution-and-niche-theory)
    - [Fitting and prediction of ecological niche model](#fitting-and-prediction-of-ecological-niche-model)
      - [Bioclim model](#bioclim-model)
      - [Gower model](#gower-model)
      - [Support vector machine (SVM)](#support-vector-machine-svm)
      - [Generalized Linear Model (GLM)](#generalized-linear-model-glm)
  - [biomod2 package](#biomod2-package)
    - [Prepare biomod2](#prepare-biomod2)
    - [Single variable model fitting and prediction](#single-variable-model-fitting-and-prediction)
    - [Multiple variables model fitting and prediction](#multiple-variables-model-fitting-and-prediction)
  - [Species migration model: KissMig](#species-migration-model-kissmig)
    - [KissMig package](#kissmig-package)
      - [kissmig()](#kissmig)
      - [kissmigAccess()](#kissmigaccess)
    - [Start using KissMig](#start-using-kissmig)

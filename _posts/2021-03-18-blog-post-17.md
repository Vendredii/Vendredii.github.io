...
plot(dis_sp)
```
![ab](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot30.jpeg)
可以根据分类环境变量将物种区分开来
```r
env2 = env
env2$habitat = "field"
...
```
![ab2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot31.jpeg)
...
plot(mod1)
```
![glm1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot32.jpeg)
残差歪了，说明不是泊松分布，可能是负二项分布？
```r
mod2 <- manyglm(dis_sp ~ env$bio1, family = "negative_binomial")
plot(mod2)
```
![glm2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot33.jpeg)
残差平衡了不少。
...
print(plot.spp)
```
![sdm](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot34.jpeg)
### 第四角分析
...
print(plot.4th)
```
![hmap](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot35.jpeg)
...
```
![hmap2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot36.jpeg)

...
```
可以得到这样一张图：  
![ggplot导出的简单散点图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot1.jpeg)  
...
```
![ggplot导出的简单散点图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot2.jpeg)
...
```
![ggplot导出的简单散点图](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot3.jpeg)
...
detach(engel)
```
![分位数回归1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot26.jpeg)
...
```
![分位数回归2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot27.jpeg)
...
```
![简单的回归](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot16.jpeg)
...
```
![简单的回归2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot17.jpeg)
...
![混合线性回归](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot18.jpeg)
...
```
![混合线性回归2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot19.jpeg)
...
```
![优势比](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot125.jpeg)
...
```
![拟合](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot126.jpeg)
...
```
![预测](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot127.jpeg)
...
```
![预测](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot128.jpeg)
...
ggplot(d, aes(longitude, latitude, size = yield, colour = variety)) + 
  geom_point()
```
![地理分布状况](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot96.jpeg)
...
```
![地理分布残差](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot97.jpeg)
...
```
![残差相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot98.jpeg)
...
```
![空间自相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot99.jpeg)

![空间自相关](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot100.jpeg)
...
```
![空间预测](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot101.jpeg)

![空间残差](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot102.jpeg)
...
manipulate({
  ...
  sd = slider(0.1, 10, 2))
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot103.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot104.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot105.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot106.jpeg)
...
manipulate({
  ...
  mu = slider(0.1, 60, 4))
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot107.jpeg)
...
```
size = 1, prob = 0.5
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot108.jpeg)

size = 10, prob = 0.4
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot109.jpeg)
...
plot(x, y)
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot110.jpeg)
...
d$x_group <- findInterval(d$x, seq(min(d$x), max(d$x), length.out = 15))
 group_by(d, x_group) %>%
  ...
  geom_point()
```
![拟合](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot111.jpeg)
...
ggeffects::ggpredict(m_poisson, "x", full.data = TRUE) %>%
  ...
  geom_point()
```
![拟合](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot112.jpeg)

如果我们看残差，它们应该和预测的平均值保持不变。在残差中很难看到这些模式。虽然我们知道有过度分散，但这里没有太多可看的东西。
```r
plot(fitted(m_poisson), residuals(m_poisson))
```
![残差](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot113.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot114.jpeg)

![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot115.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot116.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot117.jpeg)
...
ggplot(d, aes(fare, survived, colour = as.factor(female), size = age)) +  # exercise
  geom_point(position = position_jitter(height = 0.2)) # exercise
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot118.jpeg)
...
```
![分布](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot119.jpeg)
...
```
![预测曲线](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot120.jpeg)

![优势比](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot121.jpeg)
...
```
![优势比](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot122.jpeg)
...
```
![优势比](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot123.jpeg)
...
```
![优势比](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/R/Rplot124.jpeg)

...
- [Python and markdown](#python-and-markdown)
- [About compilation and coding language](#about-compilation-and-coding-language)
  - [Choose a compilation tool](#choose-a-compilation-tool)
  - [Using Github on Macbook](#using-github-on-macbook)
    - [About git](#about-git)
    - [Install and update git](#install-and-update-git)
    - [Install GitHub Desktop](#install-github-desktop)
  - [Record your learning by markdown](#record-your-learning-by-markdown)
    - [About markdown](#about-markdown)
    - [Create your blog](#create-your-blog)
- [Python](#python)
  - [Working Environment](#working-environment)
  - [Run and store your code](#run-and-store-your-code)
  - [Data processing](#data-processing)
    - [pandas\_profiling](#pandas_profiling)
    - [Make a line chart](#make-a-line-chart)
    - [Make a pie chart](#make-a-pie-chart)
    - [Make a box chart](#make-a-box-chart)
    - [Create random numbers](#create-random-numbers)
    - [Data filtering](#data-filtering)
  - [Machine learning](#machine-learning)
    - [Regression model](#regression-model)
    - [K-nearest neighbor algorithm (KNN)](#k-nearest-neighbor-algorithm-knn)
    - [Clustering algorithm (k-means)](#clustering-algorithm-k-means)
    - [Decision tree](#decision-tree)
  - [Image processing](#image-processing)
    - [Mosaics based on OpenCV](#mosaics-based-on-opencv)

# About compilation and coding language
## Choose a compilation tool
...
## Record your learning by markdown
### About markdown
...
```
# prepare the virtual environment manager
...
# deactivate
deactivate
# cd and open the current virtual environment
source bin/activate
```
## Run and store your code

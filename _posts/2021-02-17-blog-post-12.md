...
```
![barplot](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot12.jpeg)
#### 准备空间数据
准备运行环境
```r
library(marmap)
...
```
![bathydata](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot13.jpeg)
...
```
![path](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot14.jpeg)
计算最小耗费距离矩阵
```r
...
```
![SST](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot15.png)
绘制海底温度
```r
sbt.plt = ggplot()+
...
```
![SBT](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot16.png)
绘制海面盐度
```r
sss.plt = ggplot()+
...
```
![SSS](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot17.png)
绘制海底盐度
```r
sbs.plt = ggplot()+
...
```
![SBS](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot18.png)
绘制海面叶绿体浓度
```r
ssc.plt = ggplot()+
...
```
![SSC](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot19.png)
绘制海面钙含量
```r
ssca.plt = ggplot()+
...
```
![SSCA](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot20.png)
组合图片
```r
# 组合两张关于温度的
...
```
![COM](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot21.png)
### 进行冗余分析
加载环境与数据
```r
library(tidyverse)
...
```
![cor](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot22.jpeg)
识别重要变量
```r
# 使用前向选择来确定重要的环境变量
...
screeplot(rda1)
```
![rda1](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot23.jpeg)
### RDA的可视化
```r
# 创建一个数据框来正确地为区域着色
...
dev.off()
```
![rda2](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot24.png)
### 部分冗余分析
...
dev.off()
```
![rda3](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot25.png)
...
```
![rda4](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot26.jpeg)
确定分布尾部的SNP
...
```
![vpa](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot27.jpeg)
### 全流程方差分解
来自微信公众号：生态R学社
加载数据
```r
...
title('VPA')
```
![vpa](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot28.jpeg)
接下来需要检验方差结果的显著性。
```r
...
![vpa](http://github.com/Vendredii/Vendredii.github.io/blob/master/images/Rmodel/Rplot29.jpeg)
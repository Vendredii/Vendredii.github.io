...
```
可得：
![ggplot导出的简单散点图](images/R/Rplot4.jpeg)
...
```
![分类后图](images/R/Rplot12.jpeg)
或：
```r
ggplot(morph, aes(wingl, beakh)) + geom_point() +
  facet_grid(sex~taxon)
```
![分类后图2](images/R/Rplot13.jpeg)
